...
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.js"></script>
	...
	<script>
		...
		function showGraph(){
			$.post("subesatiskontrol.php",
			function(data){
				console.log(data);
				var tur_adi=[];
				var turler_sube_satis=[];
				for (var i in data){
					tur_adi.push(data[i].tur_adi);
					turler_sube_satis.push(data[i].turler_sube_satis);
				...
				var chartdata={
					...
					datasets:[
					{
					label:'Türlerin Satış Adetleri(kg)',
					data:turler_sube_satis,
					backgroundColor:[
...
<h1 style="margin-left:600px;color:#FF8C00">Buca Şubesi Türlerin Satış Dağılımı</h1>
